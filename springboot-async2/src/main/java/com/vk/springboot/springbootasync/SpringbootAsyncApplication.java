...
public class SpringbootAsyncApplication implements CommandLineRunner {
	...
	/*
	 * public TaskExecutor getAsyncExecutor() { ThreadPoolTaskExecutor executor =
	 * new ThreadPoolTaskExecutor(); executor.setCorePoolSize(2);
	 * executor.setMaxPoolSize(5);
	 * executor.setWaitForTasksToCompleteOnShutdown(true);
	 * executor.setThreadNamePrefix("AsyncThread-"); return executor; }
	 */
